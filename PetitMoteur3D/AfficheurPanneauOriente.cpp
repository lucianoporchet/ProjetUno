...
D3D11_INPUT_ELEMENT_DESC CSommetPanneauOriente::layout[] =
{
	{ "POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 0,  D3D11_INPUT_PER_VERTEX_DATA, 0 },
	{ "TEXCOORD", 0, DXGI_FORMAT_R32G32_FLOAT,    0, 12, D3D11_INPUT_PER_VERTEX_DATA, 0 }
};

UINT CSommetPanneauOriente::numElements = ARRAYSIZE(layout);

CSommetPanneauOriente CAfficheurPanneauOriente::sommets[6] =
{
	CSommetPanneauOriente(XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT2(0.0f, 1.0f)),
	CSommetPanneauOriente(XMFLOAT3(0.0f, 1.0f, 0.0f), XMFLOAT2(0.0f, 0.0f)),
	CSommetPanneauOriente(XMFLOAT3(1.0f, 1.0f, 0.0f), XMFLOAT2(1.0f, 0.0f)),
	CSommetPanneauOriente(XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT2(0.0f, 1.0f)),
	CSommetPanneauOriente(XMFLOAT3(1.0f, 1.0f, 0.0f), XMFLOAT2(1.0f, 0.0f)),
	CSommetPanneauOriente(XMFLOAT3(1.0f, 0.0f, 0.0f), XMFLOAT2(1.0f, 1.0f))
};

CAfficheurPanneauOriente::CAfficheurPanneauOriente(CDispositifD3D11* _pDispositif)
...
CAfficheurPanneauOriente ::~CAfficheurPanneauOriente()
{
...
void CAfficheurPanneauOriente::InitEffet()
{
	...
	DXEssayer(pD3DDevice->CreateInputLayout(
		CSommetPanneauOriente::layout,
		CSommetPanneauOriente::numElements,
		vsCodePtr,
		vsCodeLen,
		&pVertexLayout),
		DXE_CREATIONLAYOUT);
...
void CAfficheurPanneauOriente::Draw()
{
	// Obtenir le contexte
	...
	// Source des sommets
	const UINT stride = sizeof(CSommetPanneauOriente);
	const UINT offset = 0;
...
void CAfficheurPanneauOriente::AjouterPanneau(const std::string& NomTexture,
...
void CAfficheurPanneauOriente::Anime(float) {
